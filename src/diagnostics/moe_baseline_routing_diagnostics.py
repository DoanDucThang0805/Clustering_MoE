...
class MoeRoutingDiagnostics:
    ...
    def create_model(self, num_classes: int, num_experts: int, top_k: int, temperature: float, context_dim: int, router_mode: str, backbone_name: str, pretrain_backbone: bool) -> MoEModel:
        model = MoEModel(
            num_classes=num_classes,
            num_experts=num_experts,
            top_k=top_k,
