...
class MoeClusterClassWiseRouting:
    def __init__(
        self,
    ...
    def create_model(self, checkpoint_info: dict) -> ClusteringMoEModel:
    ...
    def run(self, batch_size: int):
        ...
        idx_to_class = {v: k for k, v in dataset.class_to_idx.items()} if hasattr(dataset, 'class_to_idx') else {}
...
def main():
    args = get_args()
    diagnostics = MoeClusterClassWiseRouting(
