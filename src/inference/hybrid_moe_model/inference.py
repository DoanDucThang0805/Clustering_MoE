"""
Inference script for HybridMoE Plant Disease Classification.
"""
...
def load_model(
    ...
    model = HybridMoEModel(
        ...
        noise_stddev      = ckpt["noise_stddev"],
        context_proj_dim  = ckpt["context_proj_dim"],
        lambda_           = ckpt["lambda_"],
...
class HybridMoEInference:
    ...
    def run(self, loader: DataLoader) -> dict:
        ...
        for images, labels, contexts in loader:
            ...
            logits, weights, top_indices, _ = self.model(images, contexts)
...
def parse_args() -> Namespace:
    parser = ArgumentParser(description="Inference HybridMoEModel on test set")
