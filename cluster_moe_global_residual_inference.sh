...
BACKBONE_TYPE="dense_global_residual_run140028"
...
# Leave empty to select the newest run containing the requested checkpoint.
RUN_TIME=""
...
echo "============================================"
echo " Dense-global Residual Cluster-MoE Inference"
echo "============================================"
echo " Seed       : $SEED"
